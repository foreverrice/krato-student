...
func (tx *Tx) init() {
	tx.StoreBalanceAccount = NewStoreBalanceAccountClient(tx.config)
	tx.StoreBalanceChangeDetail = NewStoreBalanceChangeDetailClient(tx.config)
}
...
// applies a query, for example: StoreBalanceAccount.QueryXXX(), the query will be executed
