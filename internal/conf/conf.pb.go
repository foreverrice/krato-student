...
type Resource struct {
	...
	Desc *Resource_Desc `protobuf:"bytes,1,opt,name=desc,proto3" json:"desc,omitempty"`
}
...
func (x *Resource) GetDesc() *Resource_Desc {
	if x != nil {
		return x.Desc
	}
	return nil
...
func (x *Resource_Desc) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Resource_Desc) ProtoMessage() {}

func (x *Resource_Desc) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Resource_Desc.ProtoReflect.Descriptor instead.
func (*Resource_Desc) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{3, 0}
}

func (x *Resource_Desc) GetInfo() string {
	if x != nil {
		return x.Info
	}
	return ""
...
var file_conf_conf_proto_rawDesc = []byte{
	...
	0x14, 0x2e, 0x6b, 0x72, 0x61, 0x74, 0x6f, 0x73, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x52, 0x65, 0x73,
	...
	0x69, 0x74, 0x65, 0x54, 0x69, 0x6d, 0x65, 0x6f, 0x75, 0x74, 0x22, 0x55, 0x0a, 0x08, 0x52, 0x65,
	0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x12, 0x2d, 0x0a, 0x04, 0x64, 0x65, 0x73, 0x63, 0x18, 0x01,
	0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x6b, 0x72, 0x61, 0x74, 0x6f, 0x73, 0x2e, 0x61, 0x70,
	0x69, 0x2e, 0x52, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x2e, 0x44, 0x65, 0x73, 0x63, 0x52,
	0x04, 0x64, 0x65, 0x73, 0x63, 0x1a, 0x1a, 0x0a, 0x04, 0x44, 0x65, 0x73, 0x63, 0x12, 0x12, 0x0a,
	0x04, 0x69, 0x6e, 0x66, 0x6f, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x69, 0x6e, 0x66,
	0x6f, 0x42, 0x1f, 0x5a, 0x1d, 0x68, 0x65, 0x6c, 0x6c, 0x6f, 0x77, 0x6f, 0x72, 0x6c, 0x64, 0x2f,
...
var file_conf_conf_proto_goTypes = []interface{}{
	...
	(*Resource)(nil),            // 3: kratos.api.Resource
	...
	(*Resource_Desc)(nil),       // 8: kratos.api.Resource.Desc
	(*durationpb.Duration)(nil), // 9: google.protobuf.Duration
}
var file_conf_conf_proto_depIdxs = []int32{
	1,  // 0: kratos.api.Bootstrap.server:type_name -> kratos.api.Server
	2,  // 1: kratos.api.Bootstrap.data:type_name -> kratos.api.Data
	3,  // 2: kratos.api.Bootstrap.resource:type_name -> kratos.api.Resource
	...
	8,  // 7: kratos.api.Resource.desc:type_name -> kratos.api.Resource.Desc
